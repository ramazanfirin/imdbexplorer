...
public class DownloadThread implements Runnable{
		private final Logger log = LoggerFactory.getLogger(DownloadThread.class);
	
		String[] params;
		AyonixEngineService ayonixEngineService;
		PersonRepository personRepository;
		
	    public DownloadThread(String[] params,AyonixEngineService ayonixEngineService,PersonRepository personRepository){  
